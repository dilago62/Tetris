...
public class FichaZ extends Ficha {
    ...
    private Cadrado cadrado0 = new Cadrado(4 * getXogo().getLadoCadrado(), getXogo().getLadoCadrado()*2, Color.red, getXogo().getLadoCadrado());
    private Cadrado cadrado1 = new Cadrado(4 * getXogo().getLadoCadrado(), getXogo().getLadoCadrado(), Color.red, getXogo().getLadoCadrado());
    private Cadrado cadrado2 = new Cadrado(5 * getXogo().getLadoCadrado(), getXogo().getLadoCadrado(), Color.red, getXogo().getLadoCadrado());
    private Cadrado cadrado3 = new Cadrado(5 * getXogo().getLadoCadrado(), 0, Color.red, getXogo().getLadoCadrado());
