 ...
 */
public class FichaL2 extends Ficha {

    private Cadrado cadrado0 = new Cadrado(4 * getXogo().getLadoCadrado(), 0, Color.BLUE, getXogo().getLadoCadrado());
    private Cadrado cadrado1 = new Cadrado(4 * getXogo().getLadoCadrado(), getXogo().getLadoCadrado(), Color.BLUE, getXogo().getLadoCadrado());
    private Cadrado cadrado2 = new Cadrado(4 * getXogo().getLadoCadrado(), getXogo().getLadoCadrado() * 2, Color.BLUE, getXogo().getLadoCadrado());
    private Cadrado cadrado3 = new Cadrado(3 * getXogo().getLadoCadrado(), getXogo().getLadoCadrado() * 2, Color.BLUE, getXogo().getLadoCadrado());
    private int posicion;

    public FichaL2(Xogo xogo) {
        super(xogo);
